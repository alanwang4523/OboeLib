...
Result AudioStreamBuilder::openStream(AudioStream **streamPP) {
    ...
    *streamPP = nullptr;
    ...
    if (result == Result::OK) {
        ...
        LOGE("openStream()-->getPerformanceMode = %d\n", streamP->getPerformanceMode());
        ...
        if (streamP->getPerformanceMode() == PerformanceMode::LowLatency){
            ...
            LOGE("openStream()-->>getFramesPerBurst = %d, kBufferSizeInBurstsForLowLatencyStreams = %d, optimalBufferSize = %d\n",
                    streamP->getFramesPerBurst(),
                    kBufferSizeInBurstsForLowLatencyStreams, optimalBufferSize);
