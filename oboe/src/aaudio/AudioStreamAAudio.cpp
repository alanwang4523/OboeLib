...
Result AudioStreamAAudio::open() {
    ...
    LOGD("AudioStreamAAudio.open() capacity = %d ,kCapacityRequiredForFastLegacyTrack = %d",
         static_cast<int>(mBufferCapacityInFrames), kCapacityRequiredForFastLegacyTrack);
    ...
    LOGE("AudioStreamAAudio.open()--->>>>1111");
    ...
    LOGE("AudioStreamAAudio.open()--->>>>2222");
    ...
    LOGE("AudioStreamAAudio.open()--->>>>3333");
    ...
    LOGE("AudioStreamAAudio.open()--->>>>6666");
    ...
    LOGE("AudioStreamAAudio.open() app    format = %d", static_cast<int>(mFormat));
    LOGE("AudioStreamAAudio.open() sample rate   = %d", static_cast<int>(mSampleRate));
    LOGE("AudioStreamAAudio.open() capacity      = %d", static_cast<int>(mBufferCapacityInFrames));
    LOGE("AudioStreamAAudio.open() mBufferSizeInFrames      = %d", static_cast<int>(mBufferSizeInFrames));
    LOGE("AudioStreamAAudio.open() mSharingMode      = %d", static_cast<int>(mSharingMode));
    LOGE("AudioStreamAAudio.open() mPerformanceMode      = %d", static_cast<int>(mPerformanceMode));
